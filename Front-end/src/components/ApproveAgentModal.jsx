...
const ApproveAgentModal = (props) => {
    ...
    const approveToggleButtonContent = approved ? 'Unapprove' : 'Approve';
    ...
    return(
        <>
        <div ref={modalRef} className='absolute bottom-1/2 right-1/2 transform translate-x-1/2 translate-y-1/3 flex flex-col items-center w-[450px] pt-16 bg-white rounded-xl z-50'>
            ...
            <div className='flex w-[250px] h-[40px] justify-center items-center bg-[#2A6484] text-white text-[24px] rounded-xl cursor-pointer mt-4 mb-2' onClick={() => handleContactPosterButtonClicked(agent._id)}>Contact to Poster</div>
            ...
            <div className='flex w-[250px] h-[40px] justify-center items-center text-[#2A6484] bg-white text-[24px] rounded-xl cursor-pointer mb-5 border-[2px] border-[#2A6484]' onClick={handleApproveToggle}>{approveToggleButtonContent}</div>
            <div></div>
        </div>
