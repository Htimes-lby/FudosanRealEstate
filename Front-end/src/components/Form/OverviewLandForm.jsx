    ...
    <div>
        <div className=' w-[803px]  flex gap-[124px]'>
            ...
            <div className='flex'>
                ...
                <input type="text" placeholder='万円' className='w-[381px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md'/>
            </div>
        </div>
        ...
        <div className=' w-[803px]  flex gap-[124px] pt-[14px] justify-end'>
            ...
            <div className='flex'>
                ...
                <input type="text" placeholder='m²'  className='w-[381px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md'/>
            </div>
        </div>
        ...
        <div className=' w-[803px]  flex gap-[124px] pt-[14px] justify-end'>
            ...
            <div className='flex'>
                ...
                <input type="text" placeholder='%' className='w-[381px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md'/>
            </div>
        </div>
        ...
        <div className=' w-[803px]  flex gap-[124px] pt-[14px] justify-end'>
            ...
            <div className='flex'>
                ...
                <input type="text" placeholder='木造平屋'  className='w-[381px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md'/>
            </div>
        </div> 
