    ...
    <div>
        ...
        <div className=' w-[803px]  flex gap-[124px] pt-[18px] justify-end'>
            ...
            <div className='flex'>
                ...
                <input type="text" placeholder='4LDK' className='w-[381px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md' onChange={(e) => setLayout(e.target.value)}/>
            </div>
        </div>
        ...
        <div className=' w-[803px]  flex gap-[124px] pt-[18px] justify-end'>
            ...
            <div className='flex'>
                ...
                <input type="text"  className='w-[381px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md' onChange={(e) => setDeadline(e.target.value)}/>
            </div>
        </div>
        ...
        <div className=' w-[803px]  flex gap-[124px] pt-[18px] justify-end'>
            ...
            <div className='flex'>
                ...
                <input type="text" placeholder='木造平屋'  className='w-[381px] border-[1px] focus:outline-none focus:border-blue-500 p-1 border-black rounded-md' onChange={(e) => setParking(e.target.value)}/>
            </div>
        </div>  
