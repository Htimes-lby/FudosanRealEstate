    ...
    <div>
        ...
        <div className=' w-[803px]  flex gap-[124px] pt-[18px] justify-end'>
            ...
            <div className='flex'>
                ...
                <input type="text"  className='w-[381px] border-[1px] px-2 py-[2px] focus:outline-none focus:border-blue-500 border-black rounded-md' onChange={(e) => setDeadline(e.target.value)}/>
            </div>
        </div>
