  ...
  return (
    <div>
            ...
            <div className='flex gap-[50px] '>
                <div className='w-[196px]'>
                    <div className='flex justify-between '>
                        <span>(姓)</span>
                        <input className='w-[130px]  border-[1px] outline-none focus:border-blue-500 p-1 border-black  rounded-md' type="text" onChange={(e) => setLastNameGanji(e.target.value)} />
                    </div>
                    <div className='flex justify-between pt-[16px]'>
                        <span>(せい)</span>
                        <input className='w-[130px]  border-[1px] outline-none focus:border-blue-500 p-1 border-black rounded-md' type="text" onChange={(e) => setLastNameGana(e.target.value)}  />
                    </div>
                </div> 
                <div className='w-[196px]'>
                    <div className='flex justify-between'>
                        <span>(名)</span>
                        <input className='w-[130px]  border-[1px] outline-none focus:border-blue-500 p-1 border-black rounded-md' type="text" onChange={(e) => setFirstNameGanji(e.target.value)} />
                    </div>
                    <div className='flex justify-between pt-[16px]'>
                        <span>(めい)</span>
                        <input className='w-[130px]  border-[1px] outline-none focus:border-blue-500 p-1 border-black rounded-md' type="text" onChange={(e) => setFirstNameGana(e.target.value)} />
                    </div>
                </div>      
            </div>
        </div>
        <div className=' w-[745px]  flex gap-[124px] pt-[24px]'>
            ...
            <div>
                <input type="number" className='w-[443px]  border-[1px] outline-none focus:border-blue-500 p-1 border-black rounded-md' onChange={(e) => setAge(e.target.value)}/>
            </div>
        </div>
        ...
        <div className=' w-[745px]  flex gap-[124px] pt-[24px]'>
            ...
            <div>
                <input type="text" className='w-[443px]  border-[1px] outline-none focus:border-blue-500 p-1 border-black rounded-md' onChange={(e) => setEmail(e.target.value)}/>
            </div>
        </div>
        ...
        <div className=' w-[745px]  flex gap-[110px] pt-[24px]'>
            ...
            <div className='flex '>
                <input type="number" className='w-[99px]  border-[1px] outline-none focus:border-blue-500 p-1 border-black rounded-md' value={phoneNumber[0] || ''} onChange={(e) => handleInputPhoneNumber(0, e.target.value)}/>
                <span className='border-t-2 w-[30px] border-black mt-[15px] mx-[22px]'></span>            
                <input type="number" className='w-[99px]  border-[1px] outline-none focus:border-blue-500 p-1 border-black rounded-md' value={phoneNumber[1] || ''} onChange={(e) => handleInputPhoneNumber(1, e.target.value)}/>
                <span className='border-t-2 w-[30px] border-black mt-[15px] mx-[21px]'></span>
                <input type="number" className='w-[99px]  border-[1px] outline-none focus:border-blue-500 p-1 border-black rounded-md' value={phoneNumber[2] || ''} onChange={(e) => handleInputPhoneNumber(2, e.target.value)}/>
            </div>
        </div>
        ...
        <div className=' w-[745px]  flex gap-[110px] pt-[24px]'>
            ...
            <div>              
                ...
                <input type="number" className='w-[99px]  border-[1px] outline-none focus:border-blue-500 p-1 border-black rounded-md' value={postalNumber[0] || ''} onChange={(e) => handleInputPoastalNumber(0, e.target.value)}/>
                <span className=' inline-block border-t-2 w-[30px] border-black mt-[15px] mx-[21px]  '></span>
                <input type="number" className='w-[99px]  border-[1px] outline-none focus:border-blue-500 p-1 border-black rounded-md' value={postalNumber[1] || ''} onChange={(e) => handleInputPoastalNumber(1, e.target.value)}/>
            </div>
        </div>
        ...
        <div className=' w-[745px]  flex gap-[124px] pt-[24px] justify-end'>            
            <div className=" flex items-center justify-between ">
                    ...
                    <select
                        className=" border-[1px] outline-none focus:border-blue-500 p-1 rounded-md border-black w-[272px] ml-[95px]"
        ...
        <div className=' w-[745px]  flex gap-[124px] pt-[24px] justify-end'>            
            <div className=" flex items-center justify-between ">
                    ...
                    <input type='text' className=" border-[1px] outline-none focus:border-blue-500 p-1 rounded-md border-black w-[272px] ml-[95px]" onChange={(e) => setCity(e.target.value)}/>
            </div>
        </div>
        ...
        <div className=' w-[745px]  flex gap-[124px] pt-[24px] justify-end'>            
            <div className=" flex items-center justify-between ">
                    ...
                    <input type='text' className=" border-[1px] outline-none focus:border-blue-500 p-1 rounded-md border-black w-[272px] ml-[95px]" onChange={(e) => setStreet(e.target.value)}/>
            </div>
        </div>
        ...
        <div className=' w-[745px]  flex gap-[124px] pt-[24px] justify-end'>            
            <div className=" flex items-center justify-between ">
                    ...
                    <input type='text' className=" border-[1px] outline-none focus:border-blue-500 p-1 rounded-md border-black w-[272px] ml-[22px]" onChange={(e) => setBuildingName(e.target.value)}/>
            </div>
        </div>
