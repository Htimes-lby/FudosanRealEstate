...
const Header = () => {
    ...
    return (
        <div className="w-full h-[80px] py-5 bg-[#0D4868] box-border sticky top-0 z-50">
            <div className="max-w-[1600px] text-center my-0 mx-auto">
                ...
                <div className='float-right mr-[10px]'>
                    ...
                    <div className=' relative inline-block' id='dropdown-menu'>
                        ...
                        <div className=' hidden absolute top-[40px] min-w-[120px] z-10 bg-[#0D4868]' id='dropdown-content'>
